...
""")
    ...
    with ui.tabs().classes('w-full justify-center') as tabs:
        one = ui.tab(' Planck spectrum', icon='science').props('aria-label="Activity 1: Planck Spectrum"')
        ...
        def add_cmb_activity(container):
            ...
            with container:
                ...
                info_box("Dataset: Redshift (z), CMB Temperature (K), T/z+1, T_error")
                reference_box(
                ...
                with ui.row().classes("w-full items-start justify-between gap-8 mt-4"):
                    ...
                    with ui.column().classes("w-1/2"):
                        ...
                        aria_chart_label("Adiabatic index γ")
                    ...
                    with ui.card().classes("p-6 w-full max-w-2xl min-w-[600px] bg-gray-900 text-white rounded-xl shadow-xl"):
                        ...
                        def show_adiabatic_exercise():
                            ...
                            with ui.row().classes("items-center text-lg"):
                                answer_dq["el"] = aria_formula_input().props("dense filled").classes("w-32")
                                ui.label("= ")
                                answer_du["el"] = aria_formula_input().props("dense filled").classes("w-32")
                                ui.label("+")
                                answer_pdv["el"] = aria_formula_input().props("dense filled").classes("w-32")

                            ui.label("2) Adiabatic condition").classes("step mt-2 text-blue-200")
                            with ui.row().classes("items-center text-lg"):
                                answer_dq["el2"] = aria_formula_input().props("dense filled").classes("w-32")
                                ui.label(" = ")
                                answer_zero["el"] = aria_formula_input().props("dense filled").classes("w-32")
                            with ui.row().classes("items-center text-lg"):
                                answer_du["el2"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label("+")
                                answer_pdv["el2"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label("= 0")

                            ui.label("3) Adiabatic Transformation").classes("step mt-4 text-blue-200")
                            with ui.row().classes("items-center text-lg"):
                                answer_p["el"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label("·")
                                answer_v["el"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label("^")
                                answer_gamma["el"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label(" = const")
                            with ui.row().classes("items-center text-lg"):
                                ui.label("T ∝ ")
                                answer_v["el2"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label("^(")
                                answer_gamma_uno["el"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label(")")

                            ui.label("4) Adiabatic Index").classes("step mt-4 text-blue-200")
                            with ui.row().classes("items-center text-lg"):
                                ui.label("γ = ")
                                answer_cp["el"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label("/")
                                answer_cv["el"] = aria_formula_input().props("dense filled").classes("w-20")

                            ui.label("5) Energy Equipartition").classes("step mt-4 text-blue-200")
                            with ui.row().classes("items-center text-lg"):
                                ui.label("Monoatomic gas: K = ")
                                answer_32["el"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label("kB·")
                                answer_T["el"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label(" → γ = ")
                                answer_53["el"] = aria_formula_input().props("dense filled").classes("w-20")
                            with ui.row().classes("items-center text-lg"):
                                ui.label("Biatomic gas: U = ")
                                answer_52["el"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label("nR·")
                                answer_T["el2"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label(" → γ = ")
                                answer_75["el2"] = aria_formula_input().props("dense filled").classes("w-20")

                            ui.label("6) Stefan-Boltzmann law for radiation").classes("step mt-4 text-blue-200")
                            with ui.row().classes("items-center text-lg"):
                                ui.label("U = a_rad·")
                                answer_T["el3"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label("^")
                                answer_four["el"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label("·")
                                answer_v["el3"] = aria_formula_input().props("dense filled").classes("w-20")
                            with ui.row().classes("items-center text-lg"):
                                ui.label("P = ")
                                answer_1["el"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label("/")
                                answer_3["el"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label("·")
                                answer_T["el3b"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label("^")
                                answer_four["el2"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label("·")
                                answer_v["el4"] = aria_formula_input().props("dense filled").classes("w-20")

                            ui.label("7) Doppler–Redshift relation").classes("step mt-4 text-blue-200")
                            with ui.row().classes("items-center text-lg"):
                                ui.label("1 + z = ")
                                answer_lambda_obs["el"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label("/")
                                answer_lambda_emit["el"] = aria_formula_input().props("dense filled").classes("w-20")
                            with ui.row().classes("items-center text-lg"):
                                ui.label("λ_emitted ∝ a(t) → universe expansion factor  ")
                            with ui.row().classes("items-center text-lg"):
                                ui.label("a(t)=")
                                answer_1["el2"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label("/")
                                answer_1z["el"] = aria_formula_input().props("dense filled").classes("w-20")
                            ...
                            with ui.row().classes("items-center text-lg"):
                                ui.label("T ∝ a(t)^(")
                                answer_meno1["el"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label(")")
                            with ui.row().classes("items-center text-lg"):
                                ui.label("Considering a section of the expanding universe V ∝ a(t)³")
                            with ui.row().classes("items-center text-lg"):
                                ui.label("The adiabatic expansion:T ∝ a(t)^(3(")
                                answer_gamma_uno["el2"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label("))")
                            with ui.row().classes("items-center text-lg"):
                                ui.label("T ∝ ")
                                answer_1z["el2"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label("^(")
                                answer_zrel["el"] = aria_formula_input().props("dense filled").classes("w-20")
                                ui.label(")")
                ...
                with ui.row().classes("w-full items-start justify-between gap-8 mt-4"):
                    ...
                    with ui.card().classes("p-6 w-full max-w-2xl bg-gray-900 text-white rounded-xl shadow-xl"):
                        ...
                        def show_formulas():
                            ...
                            with ui.row().classes("items-center text-lg"):
                                ui.label("ρ = ")
                                answer_u["el"] = aria_formula_input().props("dense filled").classes("w-24")                               
                                ui.label("/")
                                answer_v["el"] = aria_formula_input().props("dense filled").classes("w-24")
                            ...
                            with ui.row().classes("items-center text-lg"):
                                ui.label("Eₘ =(")   
                                answer_m["el"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label("·")
                                answer_c["el"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label("^2)")
                                ui.label("+(1/2·")
                                answer_m["el2"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label("·")
                                answer_v["el2"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label("^2)")
                                
                            ui.label("3) Matter energy density").classes("step mt-4 text-blue-200")
                            with ui.row().classes("items-center text-lg"): 
                                ui.label("ρₘ = ") 
                                answer_E["el"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label("/")
                                answer_v["el3"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label("Considering a portion of universe: V ∝ a(t)³")
                            with ui.row().classes("items-center text-lg"):
                                ui.label("ρₘ=Ωm ·ρc with ρc=(3·H0²)/(8·π·G)")
                            with ui.row().classes("items-center text-lg"):
                                ui.label("ρₘ(a) =ρₘ0· a^(")
                                answer_m3["el"] = aria_formula_input().props("dense filled").classes("w-16")
                                ui.label(")= ρₘ0·(")
                                answer_1z["el"] = aria_formula_input().props("dense filled").classes("w-16")
                                ui.label(")^")
                                answer_3["el"] = aria_formula_input().props("dense filled").classes("w-16")
                            ...
                            with ui.row().classes("items-center text-lg"):
                                ...
                                answer_h["el"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label("·")
                                answer_nu["el"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label("=")
                                answer_h["el2"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label("·")
                                answer_c["el2"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label("/")
                                answer_lambda["el"] = aria_formula_input().props("dense filled").classes("w-24")
                            ...
                            with ui.row().classes("items-center text-lg"):
                                ...
                                answer_n["el"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label("·")
                                answer_E["el2"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label("∝ a(t)^(")
                                answer_m4["el"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label(")")
                            with ui.row().classes("items-center text-lg"):
                                ui.label("From the Stefan-Boltzmann law: ρᵣ= a_rad ·")
                                answer_T["el"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label("^")
                                answer_4["el"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label("with T ∝ a(t)^(-1)")
                            with ui.row().classes("items-center text-lg"):
                                ui.label("ρᵣ=Ωr ·ρc ")
                            with ui.row().classes("items-center text-lg"):
                                ui.label("ρᵣ(a) =ρᵣ0· a^(")
                                answer_m4["el2"] = aria_formula_input().props("dense filled").classes("w-16")
                                ui.label(")= ρᵣ0·(")
                                answer_1z["el2"] = aria_formula_input().props("dense filled").classes("w-16")
                                ui.label(")^")
                                answer_4["el2"] = aria_formula_input().props("dense filled").classes("w-16")
                            ...
                            with ui.row().classes("items-center text-lg"):
                                answer_rhom["el"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label("(z_eq) = ")
                                answer_rhor["el"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label("(z_eq)  ")

                            ui.label("6) Redshift of equivalence").classes("step mt-4 text-blue-200")
                            with ui.row().classes("items-center text-lg"):
                                ui.label("1 + z_eq = ")
                                answer_rhom0["el"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label("/")
                                answer_rhor0["el"] = aria_formula_input().props("dense filled").classes("w-24")

                            ui.label("7) Temperature–redshift relation").classes("step mt-4 text-blue-200")
                            with ui.row().classes("items-center text-lg"):
                                ui.label("T(z) = ")
                                answer_T0["el"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label("·(")
                                answer_1z["el3"] = aria_formula_input().props("dense filled").classes("w-24")
                                ui.label(")")
                    ...
                    def plot_curves(show_curves=False):
                        with ui.column().classes("w-1/2 items-center"):
                            with ui.pyplot():
                                plt.title("Matter and Radiation Density vs Redshift")
                                plt.xlabel("1 + z")
                                ...
                                plt.yscale("log")
                                if show_curves:
                                    plt.plot(1 + z_grid, rho_m, label="Matter density ρₘ", color="blue", lw=2)
                                    plt.plot(1 + z_grid, rho_r, label="Radiation density ρᵣ", color="red", lw=2)
                                    plt.legend()
                                plt.tight_layout()
